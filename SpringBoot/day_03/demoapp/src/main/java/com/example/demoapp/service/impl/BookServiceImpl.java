...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> sortBooksByYear() {return bookDAO.sortBookByYear();}

    @Override
    public List<Book> searchBook(String keyword) {return bookDAO.searchBook(keyword);}

    @Override
    public List<Book> searchBookByYear(int startYear, int endYear) {return bookDAO.searchBookByYear(startYear, endYear);}
}
